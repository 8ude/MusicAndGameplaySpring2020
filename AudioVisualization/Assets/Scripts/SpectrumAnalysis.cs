...
public class SpectrumAnalysis : MonoBehaviour {
    ...
    //"whole energy" seems misleading, no idea what that refers to
	public float GetWholeEnergy(){
		float wholeEnergy = 0;

        //this is squaring the data, which ends up making the values smaller (each bin is on a 0-1 range)
    ...
    //todo - fix and test scaling, try adapting this:https://answers.unity.com/questions/157940/getoutputdata-and-getspectrumdata-they-represent-t.html
